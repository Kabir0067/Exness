...
from core.risk_engine import PortfolioRiskManager, AssetExposure
...
from .execution import ExecutionManager, ExecutionWorker, EngineExecutionMixin
from .fsm import DeterministicFSMRunner, EngineFSMStageServices, EngineRuntimeMixin
from .models import EngineCycleContext, EngineState
from .inference import InferenceEngine, EngineModelMixin
from .models import _DIAG_ENABLED, _DIAG_EVERY_SEC, log_diag, log_err, log_health
from .models import AssetCandidate, ExecutionResult, OrderIntent, PortfolioStatus
from .execution import OrderSyncManager
from .pipeline import _AssetPipeline, EnginePipelineMixin
from .pipeline import EngineScheduleManager, UTCScheduler
from .models import safe_json_dumps
from core.signal_engine import MLSignal
from core.model_engine import model_manager  # <--- HOLY TRINITY GATEKEEPER
...
class MultiAssetTradingEngine(
    ...
    def __init__(self, dry_run: bool = False) -> None:
        ...
        self._analysis_signal_last_notified: Dict[str, Tuple[str, str]] = {"XAU": ("", "Neutral"), "BTC": ("", "Neutral")}
